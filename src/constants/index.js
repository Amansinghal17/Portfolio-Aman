...
export const experiences = [
  {
    ...
    date: "2024-Present",
    contents: [
      "Developed and maintained a large-scale Insurance Dashboard using Angular 17, Node.js, and Express.js for POSP, Admin, Account Manager, Region Admin, Division Head, Branch Head, and Operations teams.",
      "Built RESTful APIs for policy management, user administration, and insurance workflows to enable seamless front-end/back-end communication.",
      "Implemented secure RBAC across Angular and Node.js layers with granular permissions to protect mission-critical APIs.",
      "Designed reusable Angular Material UI components with TypeScript, HTML, CSS, and Flex Layout for consistent, scalable interface architecture.",
      "Managed state and async data flows with NgRx and RxJS, improving application predictability and performance.",
      "Integrated API services and middleware in Angular and Node.js for better error handling, authentication, and data consistency.",
      "Optimized performance through lazy loading, code splitting, API tuning, and efficient backend request handling, achieving significant speed gains.",
      "Designed MongoDB schemas and optimized queries for scalable storage, delivering features in Agile/Scrum with CI/CD, Git, and code review best practices.",
    ],
  },
  // {
